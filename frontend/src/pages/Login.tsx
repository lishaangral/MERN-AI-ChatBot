      ...
      >
        <div className="rounded-2xl border border-white/10 bg-surface p-8 shadow-2xl">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-surface-foreground/70">Log in to your Augmentum account</p>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-white/5 bg-white/[0.02] p-3 text-xs text-surface-foreground/40 leading-relaxed">
            <p><strong>Disclaimer:</strong> Augmentum is a research assistance tool. Responses from the RAG workspace are based on your uploaded documents. Gemini Chat responses are generated by Google's AI and may not always be accurate. Always verify critical information with original sources.</p>
          </div>
        </div>
      </motion.div>
    </div>
